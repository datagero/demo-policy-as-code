...
echo "kubectl create configmap opa-policies --from-file=access_policy.rego=../policies/access_policy.rego -n opa-policy --dry-run=client -o yaml | kubectl apply -f -" 